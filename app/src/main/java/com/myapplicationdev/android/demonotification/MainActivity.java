...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNotfiy1 = findViewById(R.id.btnNotify1);
        btnNotify2 = findViewById(R.id.btnNotify2);

        btnNotfiy1.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btnNotify2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bigText.bigText("This is one big text" +
                        " - A quick brown for jumps over a lazy brown dog " +
